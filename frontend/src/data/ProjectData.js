        ...
        subprojects: [
            {
                ...
                description: [
                    ...
                    "Overall, the results obtained from these simulations are helpful both from a end user perspective, and from a business perspective. For the user, it helps to understand just how obtainable the cards within the game are, and thus helps to set realistic expectations based on a player's monetary category (free-to-play, Premium Pass-only, dolphin, whale, etc.). Conversely, from a business perspective, such simulations are important to determine where the sweet spot is for balancing enjoyment of the users with profitability - and thus ensuring user retention. Each of these can thus relate to the ethics of the game, and are discussed more fully in the the website project below, where I analyzed the results of the simulations."
                ]
            },
            {
